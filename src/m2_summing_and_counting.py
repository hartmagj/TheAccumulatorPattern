...
"""  # s: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
def run_test_sum_more_cosines():
    ...
    expected = 0.61241  # This is APPROXIMATELY the correct answer.
...
def sum_more_cosines(m, n):
    ...
    """
    # ------------------------------------------------------------------
    # s: 3. Implement and test this function.
...
def run_test_count_sines_vs_cosines():
    ...
    expected = 25
    answer = count_sines_vs_cosines(24)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
